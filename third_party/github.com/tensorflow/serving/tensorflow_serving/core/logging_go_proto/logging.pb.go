...
package logging_go_proto

import (
	model_go_proto "github.com/tensorflow/serving/tensorflow_serving/apis/model_go_proto"
	logging_config_go_proto "github.com/tensorflow/serving/tensorflow_serving/config/logging_config_go_proto"
...
type LogMetadata struct {
	...
	SamplingConfig *logging_config_go_proto.SamplingConfig `protobuf:"bytes,2,opt,name=sampling_config,json=samplingConfig,proto3" json:"sampling_config,omitempty"`
...
func (x *LogMetadata) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
func (x *LogMetadata) GetSamplingConfig() *logging_config_go_proto.SamplingConfig {
	if x != nil {
...
var file_tensorflow_serving_core_logging_proto_rawDesc = []byte{
	...
	0x6c, 0x54, 0x61, 0x67, 0x73, 0x42, 0x4b, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f,
	0x77, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x6c,
	0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xf8,
...
var file_tensorflow_serving_core_logging_proto_goTypes = []interface{}{
	...
	(*model_go_proto.ModelSpec)(nil),               // 1: tensorflow.serving.ModelSpec
	(*logging_config_go_proto.SamplingConfig)(nil), // 2: tensorflow.serving.SamplingConfig
}
