...
package prediction_log_go_proto
...
import (
	...
	session_service_go_proto "github.com/tensorflow/serving/tensorflow_serving/apis/session_service_go_proto"
	logging_go_proto "github.com/tensorflow/serving/tensorflow_serving/core/logging_go_proto"
...
type ClassifyLog struct {
	...
	Request  *classification_go_proto.ClassificationRequest  `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
	Response *classification_go_proto.ClassificationResponse `protobuf:"bytes,2,opt,name=response,proto3" json:"response,omitempty"`
}
...
func (x *ClassifyLog) GetRequest() *classification_go_proto.ClassificationRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *ClassifyLog) GetResponse() *classification_go_proto.ClassificationResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
type RegressLog struct {
	...
	Request  *regression_go_proto.RegressionRequest  `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
	Response *regression_go_proto.RegressionResponse `protobuf:"bytes,2,opt,name=response,proto3" json:"response,omitempty"`
}
...
func (x *RegressLog) GetRequest() *regression_go_proto.RegressionRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *RegressLog) GetResponse() *regression_go_proto.RegressionResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
type PredictLog struct {
	...
	Request  *predict_go_proto.PredictRequest  `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
	Response *predict_go_proto.PredictResponse `protobuf:"bytes,2,opt,name=response,proto3" json:"response,omitempty"`
}
...
func (x *PredictLog) GetRequest() *predict_go_proto.PredictRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *PredictLog) GetResponse() *predict_go_proto.PredictResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
type MultiInferenceLog struct {
	...
	Request  *inference_go_proto.MultiInferenceRequest  `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
	Response *inference_go_proto.MultiInferenceResponse `protobuf:"bytes,2,opt,name=response,proto3" json:"response,omitempty"`
}
...
func (x *MultiInferenceLog) GetRequest() *inference_go_proto.MultiInferenceRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *MultiInferenceLog) GetResponse() *inference_go_proto.MultiInferenceResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
type SessionRunLog struct {
	...
	Request  *session_service_go_proto.SessionRunRequest  `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
	Response *session_service_go_proto.SessionRunResponse `protobuf:"bytes,2,opt,name=response,proto3" json:"response,omitempty"`
}
...
func (x *SessionRunLog) GetRequest() *session_service_go_proto.SessionRunRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *SessionRunLog) GetResponse() *session_service_go_proto.SessionRunResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
type PredictionLog struct {
	...
	LogMetadata *logging_go_proto.LogMetadata `protobuf:"bytes,1,opt,name=log_metadata,json=logMetadata,proto3" json:"log_metadata,omitempty"`
...
func (x *PredictionLog) GetLogMetadata() *logging_go_proto.LogMetadata {
	if x != nil {
...
var file_tensorflow_serving_apis_prediction_log_proto_rawDesc = []byte{
	...
	0x67, 0x42, 0x0a, 0x0a, 0x08, 0x6c, 0x6f, 0x67, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x42, 0x52, 0x5a,
	0x4d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x65, 0x6e, 0x73,
	...
	0x67, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x6c, 0x6f, 0x67, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xf8, 0x01,
...
var file_tensorflow_serving_apis_prediction_log_proto_goTypes = []interface{}{
	...
	(*classification_go_proto.ClassificationRequest)(nil),  // 6: tensorflow.serving.ClassificationRequest
	(*classification_go_proto.ClassificationResponse)(nil), // 7: tensorflow.serving.ClassificationResponse
	(*regression_go_proto.RegressionRequest)(nil),          // 8: tensorflow.serving.RegressionRequest
	(*regression_go_proto.RegressionResponse)(nil),         // 9: tensorflow.serving.RegressionResponse
	(*predict_go_proto.PredictRequest)(nil),                // 10: tensorflow.serving.PredictRequest
	(*predict_go_proto.PredictResponse)(nil),               // 11: tensorflow.serving.PredictResponse
	(*inference_go_proto.MultiInferenceRequest)(nil),       // 12: tensorflow.serving.MultiInferenceRequest
	(*inference_go_proto.MultiInferenceResponse)(nil),      // 13: tensorflow.serving.MultiInferenceResponse
	(*session_service_go_proto.SessionRunRequest)(nil),     // 14: tensorflow.serving.SessionRunRequest
	(*session_service_go_proto.SessionRunResponse)(nil),    // 15: tensorflow.serving.SessionRunResponse
	(*logging_go_proto.LogMetadata)(nil),                   // 16: tensorflow.serving.LogMetadata
}
