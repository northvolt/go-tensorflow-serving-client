...
package session_service_go_proto
...
func (x *SessionRunRequest) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
type SessionRunResponse struct {
	...
	ModelSpec *model_go_proto.ModelSpec `protobuf:"bytes,3,opt,name=model_spec,json=modelSpec,proto3" json:"model_spec,omitempty"`
...
func (x *SessionRunResponse) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
var file_tensorflow_serving_apis_session_service_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x53, 0x5a, 0x4e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69,
	...
	0x6f, 0x6e, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72,
...
var file_tensorflow_serving_apis_session_service_proto_goTypes = []interface{}{
	...
	(*model_go_proto.ModelSpec)(nil),                  // 2: tensorflow.serving.ModelSpec
