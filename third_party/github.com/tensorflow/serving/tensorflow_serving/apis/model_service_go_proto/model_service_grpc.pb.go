...
package model_service_go_proto

import (
	context "context"
	get_model_status_go_proto "github.com/tensorflow/serving/tensorflow_serving/apis/get_model_status_go_proto"
	model_management_go_proto "github.com/tensorflow/serving/tensorflow_serving/apis/model_management_go_proto"
...
type ModelServiceClient interface {
	...
	GetModelStatus(ctx context.Context, in *get_model_status_go_proto.GetModelStatusRequest, opts ...grpc.CallOption) (*get_model_status_go_proto.GetModelStatusResponse, error)
	...
	// longer served.
	HandleReloadConfigRequest(ctx context.Context, in *model_management_go_proto.ReloadConfigRequest, opts ...grpc.CallOption) (*model_management_go_proto.ReloadConfigResponse, error)
}
...
func (c *modelServiceClient) GetModelStatus(ctx context.Context, in *get_model_status_go_proto.GetModelStatusRequest, opts ...grpc.CallOption) (*get_model_status_go_proto.GetModelStatusResponse, error) {
	out := new(get_model_status_go_proto.GetModelStatusResponse)
...
func (c *modelServiceClient) HandleReloadConfigRequest(ctx context.Context, in *model_management_go_proto.ReloadConfigRequest, opts ...grpc.CallOption) (*model_management_go_proto.ReloadConfigResponse, error) {
	out := new(model_management_go_proto.ReloadConfigResponse)
...
type ModelServiceServer interface {
	...
	// the ModelSpec in the request does specify a version, the status of only
	// that version will be returned.
	GetModelStatus(context.Context, *get_model_status_go_proto.GetModelStatusRequest) (*get_model_status_go_proto.GetModelStatusResponse, error)
	// Reloads the set of served models. The new config supersedes the old one,
	// so if a model is omitted from the new config it will be unloaded and no
	// longer served.
	HandleReloadConfigRequest(context.Context, *model_management_go_proto.ReloadConfigRequest) (*model_management_go_proto.ReloadConfigResponse, error)
...
func (UnimplementedModelServiceServer) GetModelStatus(context.Context, *get_model_status_go_proto.GetModelStatusRequest) (*get_model_status_go_proto.GetModelStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetModelStatus not implemented")
}
func (UnimplementedModelServiceServer) HandleReloadConfigRequest(context.Context, *model_management_go_proto.ReloadConfigRequest) (*model_management_go_proto.ReloadConfigResponse, error) {
...
func _ModelService_GetModelStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(get_model_status_go_proto.GetModelStatusRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ModelServiceServer).GetModelStatus(ctx, req.(*get_model_status_go_proto.GetModelStatusRequest))
	}
...
func _ModelService_HandleReloadConfigRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model_management_go_proto.ReloadConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ModelServiceServer).HandleReloadConfigRequest(ctx, req.(*model_management_go_proto.ReloadConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
